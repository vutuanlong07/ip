public final class Dialogues {
    public static final String Banner = "____  ___\n" +
    ...
    public static final String UnmarkNoChange = "No items were unmarked (= ~ =)";
    public static final String DeleteNoChange = "No items were deleted (= ~ =)";

    public static final String MarkMissingArguments = "Indicate an index to mark -_-\"";
    public static final String UnmarkMissingArguments = "Indicate an index to unmark -_-\"";
    public static final String DeleteMissingArguments = "Indicate an index to delete -_-\"";
    public static final String TaskItemMissingName = "Task name can't be empty, duh °∀°?";
    public static final String DeadlineMissing = "Missing deadline for task -_-\"";
    public static final String EventMissingStart = "Missing start time for event -_-\"";
